...
#     def __init__(self, palabra, imagen, color):
...
#         try:
#             listado = []
#             with open(self.archivo, 'rt', encoding='UFT-8') as f:
#                 for i in f.readlines():
#                     division = i.split(';')
#                     recom = Recomendaciones(division[1], division[2], division[3].strip())
        ...
        try:
            ...
            with open(self.nombre_archivo, 'rt', encoding='utf-8') as f:
                for l in f.readlines():
                    partes = l.split(';')
                    contacto = Contacto(partes[0], partes[1].strip())
                    contactos.append(contacto)

                    partes = l.split(';')
                    contacto5 = Contacto(partes[2].strip())
                    contacto1.append(contacto5)

            return contacto, contacto5
        except:
            return None
...
if __name__ == "__main__":
    main()
        ...
        # elif self.emotion < 1.5:
        #     self.data = f.readlines()[2]
        #     return self.data
                        
        # elif self.emotion < 2.5:
        #     self.data = f.readlines()[3]
        #     return self.data
                        
        # elif self.emotion < 3:
        #     self.data = f.readlines()[4]
        #     return self.data                        
                    
        # elif self.emotion < 3.5:
        #     self.data = f.readlines()[5]
        #     return self.data     
                    
        # elif self.emotion == 4:
        #     self.data = f.readlines()[6]
        #     return self.data 
                    
        # elif self.emotion == 4.5:
        #     self.data = f.readlines()[7]
        #     return self.data
                    
        # elif self.emotion == 5:
        #     self.data = f.readlines()[8]
        #     return self.data
                        
        # elif self.emotion == 5.5:
        #     self.data = f.readlines()[9]
        #     return self.data 
                        
        # elif self.emotion == 6:
        #     self.data = f.readlines()[10]
        #     return self.data
                    
        # elif self.emotion > 6.5:
        #     self.data = f.readlines()[11]
        #     return self.data  
                    
        # elif self.emotion > 7:
        #     self.data = f.readlines()[12]
        #     return self.data
                        
        # elif self.emotion > 7.5:
        #     self.data = f.readlines()[13]
        #     return self.data
                    
        # elif self.emotion > 8:
        #     self.data = f.readlines()[14]
        #     return self.data
                    
        # elif self.emotion > 8.5:
        #     self.data = f.readlines()[15]
        #     return self.data  
                    
        # elif self.emotion > 9.5:
        #     self.data = f.readlines()[16]
        #     return self.data                          
